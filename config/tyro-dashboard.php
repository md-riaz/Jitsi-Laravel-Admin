    ...
    */
    ...
    'resources' => [
        ...
        'subscription_plans' => [
            ...
            'roles' => ['super-admin'],
            'icon' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" /></svg>',
            'fields' => [
                'name' => ['type' => 'text', 'label' => 'Plan Name', 'rules' => 'required|string|max:255', 'searchable' => true],
                'slug' => ['type' => 'text', 'label' => 'Slug', 'rules' => 'required|string|max:100', 'searchable' => true],
                'description' => ['type' => 'textarea', 'label' => 'Description', 'rules' => 'nullable|string'],
                'price' => ['type' => 'number', 'label' => 'Price', 'rules' => 'required|numeric|min:0', 'help_text' => 'Monthly/yearly price in USD'],
                'billing_cycle' => ['type' => 'select', 'label' => 'Billing Cycle', 'options' => ['monthly' => 'Monthly', 'yearly' => 'Yearly', 'one-time' => 'One-time'], 'rules' => 'required|string'],
                'max_users' => ['type' => 'number', 'label' => 'Max Users', 'rules' => 'nullable|integer|min:1', 'help_text' => 'Leave blank for unlimited'],
                'max_meeting_duration' => ['type' => 'number', 'label' => 'Max Meeting Duration (min)', 'rules' => 'nullable|integer|min:1', 'help_text' => 'Leave blank for unlimited'],
                'recording_storage_gb' => ['type' => 'number', 'label' => 'Recording Storage (GB)', 'rules' => 'nullable|integer|min:0', 'help_text' => 'Leave blank for unlimited'],
                'concurrent_meetings' => ['type' => 'number', 'label' => 'Concurrent Meetings', 'rules' => 'nullable|integer|min:1', 'help_text' => 'Leave blank for unlimited'],
                'trial_days' => ['type' => 'number', 'label' => 'Trial Days', 'rules' => 'nullable|integer|min:0', 'default' => 0],
